...
def populate_db():
    ...
    admin_3 = Post(title='How to get 15 inch arms from bodyweight only', content='3 sets of 8 20kg weighted chin ups\n 3 sets of 8 dips', author=admin, date_posted=datetime.today()-timedelta(days=2))
    ...
    admin_5 = Post(title='stop snitching', content='we dont conversate!', author=admin, date_posted=datetime.today()-timedelta(days=5))
    ...
    test_1 = Post(title='never gonna give u up vs africa by toto', content=filler, author=test, date_posted=datetime.today()-timedelta(days=1))
